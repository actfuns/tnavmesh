...
# render --points
$BIN render -n /tmp/test_simple.bin --points "32,32 160,160 288,288" -o /tmp/test_render.svg > /dev/null 2>&1
...
$BIN render -n /tmp/test_simple.bin -i /tmp/test_pts.txt -o /tmp/test_render2.svg > /dev/null 2>&1
echo "  [OK] render -i"
